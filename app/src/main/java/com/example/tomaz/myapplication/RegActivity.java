...
public class RegActivity extends ActionBarActivity {
    ...
    public void regClick(View v) {
        ...
        name = ((EditText) findViewById(R.id.regName)).getText().toString();
        surname = ((EditText) findViewById(R.id.regSurname)).getText().toString();
        password = md5(((EditText) findViewById(R.id.regPassword)).getText().toString());
        ...
        if (username.equals("") || name.equals("") || surname.equals("") || password.equals("")){
            ...
            String URL = "http://fri-is-63130239.azurewebsites.net/Service1.svc/Register/" + Uri.encode(username) + "/" + Uri.encode(name) + "/" + Uri.encode(surname) + "/" + password;
    ...
    private class RestCallTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if(result.equals("true")) {
                Intent newIntent = new Intent(RegActivity.this, RestActivity.class);
                ...
                Context context = getApplicationContext();
                CharSequence error = "Username already exists!";
                int duration = Toast.LENGTH_SHORT;
                Toast toast = Toast.makeText(context, error, duration);
                toast.show();
            }
